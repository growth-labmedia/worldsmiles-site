...
/**
 * Homepage. Client direction (Sept 25, 2026): say "prosthodontist" immediately, pictures over words,
 * no comparisons to other dentists, "Request an Appointment" / "Contact Us" wording, under ~200 words of body copy.
 */
const TILES = [
  { name: 'Dental Implants', caption: 'Single tooth to full arch', img: implantsImg, to: '/services/dental-implants' },
  { name: 'Full Mouth Reconstruction', caption: 'One coordinated plan', img: allOnXImg, to: '/services/full-mouth-reconstruction' },
  { name: 'Crowns & Bridges', caption: 'All-ceramic, same-day options', img: veneersDetailImg, to: '/services/crowns-bridges' }, // TODO(client): dedicated crowns photo
  { name: 'Dentures', caption: 'Complete, partial, implant-supported', img: denturesImg, to: '/services/dentures' },
  { name: 'Porcelain Veneers', caption: 'Natural-looking porcelain', img: veneersImg, to: '/services/veneers' },
  { name: 'Specialist Second Opinion', caption: 'Bring your treatment plan', img: scanImg, to: '/second-opinion' },
];

const RESULTS = [
  { label: 'Full mouth reconstruction', to: '/services/full-mouth-reconstruction', before: fmrBefore, after: fmrAfter, beforeAlt: 'Before full mouth ceramic rehabilitation', afterAlt: 'After full mouth ceramic rehabilitation' },
  { label: 'Dental implants', to: '/services/dental-implants', before: implantsBefore, after: implantsAfter, beforeAlt: 'Before: 7 implants with periodontal coordination', afterAlt: 'After: 7 implants with periodontal coordination' },
  { label: 'Porcelain veneers', to: '/services/veneers', before: veneersBefore, after: veneersAfter, beforeAlt: 'Before: ceramic veneer reconstruction', afterAlt: 'After: ceramic veneer reconstruction' },
];
...
export default function HomePage() {
  ...
  return (
    <>
      {/* HERO */}
      <section className="bg-[#F7F3EC] pt-6 pb-6 md:pt-8 md:pb-8">
        <div className="max-w-[1100px] mx-auto px-4 md:px-6">
          <div className="text-center max-w-[820px] mx-auto">
            ...
            <h1 className="text-[1.875rem] md:text-[2.25rem] lg:text-[2.5rem] leading-[1.08] tracking-[-0.02em] font-[Fraunces,Georgia,serif] font-medium mt-2 text-[#0A0A0A]">
              Prosthodontist in Brooklyn.
            </h1>
            <p className="mt-2 text-[0.9375rem] md:text-[1rem] leading-[1.5] text-[#1B1B1B] max-w-[52ch] mx-auto">
              A dental specialist in implants, crowns, dentures and full-mouth reconstruction.
            </p>
          </div>

          <div className="mt-5">
            <div className="relative w-full rounded-xl overflow-hidden shadow-lg bg-[#0A0A0A] mx-auto" style={{ aspectRatio: '16 / 9', maxWidth: '440px' }}>
              <iframe
      ...
      <section className="bg-white py-10 md:py-14">
        <div className="max-w-[1200px] mx-auto px-4 md:px-6">
          ...
          <div className="mt-8 text-center">
            <Link to="/services" className="inline-flex items-center gap-1.5 text-[#0A0A0A] hover:text-[#A8893F] text-[0.9375rem] font-semibold min-h-[48px]">
