          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
            ...
            <div>
              ...
              <ul className="text-[0.9375rem] text-[#F7F3EC]/85 space-y-2.5">
                ...
                <li><Link to="/blog" className={`rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#C9A961] ${currentPath === '/blog' ? 'text-white font-medium' : 'hover:text-white'}`}>Journal</Link></li>
