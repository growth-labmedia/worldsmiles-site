...
const ROUTES = {
  ...
  '/privacy': 'PrivacyPage',
  '/terms': 'TermsPage',
  '/services/dental-implants': 'ServiceDentalImplantsPage',
  '/services/all-on-x': 'ServiceAllOnXPage',
  '/services/dentures': 'ServiceDenturesPage',
  '/services/full-mouth-reconstruction': 'ServiceFullMouthPage',
  '/services/crowns-bridges': 'ServiceCrownsBridgesPage',
  '/services/veneers': 'ServiceVeneersPage',
  '/landing': 'LandingPage',
